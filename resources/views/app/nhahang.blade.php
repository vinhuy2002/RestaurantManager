                        ...
                        <div class="bg-image">
                            ...
                            <div class="mask" style="background-color: rgba(0, 0, 0, 0.5);">
                                <div class="justify-content-center align-items-center h-100 " style="margin:20px">
                                    <h4 class="text-white mb-0">{{$user['Ten_nha_hang']}}</h4><br>
							...
							<h4 class="text-white rounded" style="position: absolute; bottom: 10px; right: 16px; background-color: rgba(0, 0, 0, 0.8); padding:15px">{{$user['Ten_nha_hang']}}</h4>
						</div>
                    </div>
