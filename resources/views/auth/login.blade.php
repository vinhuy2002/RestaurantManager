                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-10 col-lg-7 col-xl-7 d-flex align-items-center order-1 order-lg-1">
                                    <div class="text-center">
                                        ...
                                        <img src="{{ URL('images1/login.png') }}" class="img-fluid"
                                            alt="Sample image">
                                        <p class="mt-1 mb-2 pb-1">Chúng tôi giúp bạn quản lý nhanh chóng và tiện lợi nhà
                                            hàng của mình.</p>
                                    </div>
                                ...
                                <div class="col-md-10 col-lg-5 col-xl-5 order-2 order-lg-2">
                                    ...
                                    <form class="mx-1 mx-md-4" method="POST"
                                        ...
                                        <label class="form-label" for="email">Email</label> -->
                                                ...
                                                <input class="form-control" id="auth" type="text" name="ten_dang_nhap"
                                                    value="{{ old('ten_dang_nhap') }}" required autofocus />
                                                <label class="form-label" for="auth">Tên đăng nhập hoặc
                                                    email</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="text-center pt-1 mb-5 pb-1">
                                            <button
                                                class="btn btn-primary btn-lg  btn-block fa-lg gradient-custom-2 mb-3"
