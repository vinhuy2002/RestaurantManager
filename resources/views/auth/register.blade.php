                                    ...
                                    <form class="mx-1 mx-md-4" method="POST" action="{{ route('registerStore') }}"> 
                                        ...
                                        <div class="d-flex flex-row align-items-center mt-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="text" id="Ten_nha_hang" name="Ten_nha_hang" :value="old('Ten_nha_hang')" required autofocus autocomplete="Ten_nha_hang" class="form-control" />
                                        ...
                                        <div class="d-flex flex-row align-items-center mt-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="text" id="Dia_chi" name="Dia_chi" :value="old('Dia_chi')" required autofocus autocomplete="Dia_chi" class="form-control" />
                                        ...
                                        <div class="d-flex flex-row align-items-center mt-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="text" id="SDT" name="SDT" :value="old('SDT')" required autofocus autocomplete="SDT" class="form-control" />
                                      ...
                                      <!--   <div class="d-flex flex-row align-items-center mt-4">
                                        ...
                                        <div class="d-flex flex-row align-items-center mt-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="text" id="Ten_dang_nhap" name="Ten_dang_nhap" :value="old('Ten_dang_nhap')" required autofocus autocomplete="Ten_dang_nhap" class="form-control" />
                                        ...
                                        <div class="d-flex align-items-center justify-content-center pb-1">
                                            ...
                                            <a href="{{ route('auth.login') }}" type="button" class="btn btn-outline-success">Đăng nhập</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
